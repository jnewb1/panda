...
class SubaruSafetyGen2Data(SubaruSafetyGen1Data):
  ALT_BUS = 1
...
class Common:
  class TestSubaruSafetyCommon(common.PandaSafetyTest, common.DriverTorqueSteeringSafetyTest):
    def setUp(self):
  ...
  class TestSubaruLongitudinalSafetyCommon(TestSubaruSafetyCommon):
...
class TestSubaruGen1Safety(SubaruSafetyGen1Data, Common.TestSubaruSafetyCommon):
  FLAGS = 0
  TX_MSGS = [[0x122, 0], [0x221, 0], [0x321, 0], [0x322, 0], [0x323, 0]]
  FWD_BLACKLISTED_ADDRS = {2: [0x122, 0x321, 0x322, 0x323]}

class TestSubaruGen2Safety(SubaruSafetyGen2Data, Common.TestSubaruSafetyCommon):
  FLAGS = Panda.FLAG_SUBARU_GEN2
  TX_MSGS = [[0x122, 0], [0x221, 1], [0x321, 0], [0x322, 0], [0x323, 0]]
  FWD_BLACKLISTED_ADDRS = {2: [0x122, 0x321, 0x322, 0x323]}

class TestSubaruGen1LongitudinalSafety(SubaruSafetyGen1Data, Common.TestSubaruLongitudinalSafetyCommon):
...
class TestSubaruGen2LongitudinalSafety(SubaruSafetyGen2Data, Common.TestSubaruLongitudinalSafetyCommon):
  FLAGS = Panda.FLAG_SUBARU_LONG | Panda.FLAG_SUBARU_GEN2
  TX_MSGS = [[0x122, 0], [0x220, 1], [0x221, 1], [0x222, 1], [0x321, 0], [0x322, 0], [0x323, 0], [0x240, 2], [0x13c, 2], [0x787, 2], [0x121, 0], [0x22a, 0], [0x325, 0]]
  FWD_BLACKLISTED_ADDRS = {0: [0x240, 0x13c], 2: [0x122, 0x220, 0x221, 0x222, 0x321, 0x322, 0x323]}
